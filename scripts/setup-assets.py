...
SONGS = [
    ...
    },
    {
        ...
        "bpm": BPM,
        "musical_key": "C",
        "interest_tags": ["nursery", "round"],
        "lines": [
            ('Row, row, row your boat,', [("C4", 1), ("C4", 1), ("C4", 1), ("D4", 1), ("E4", 2)]),
            ('Gently down the stream.', [("E4", 1), ("D4", 1), ("E4", 1), ("F4", 1), ("G4", 2)]),
            ('Merrily, merrily, merrily, merrily,', [("C5", 0.5), ("G4", 0.5), ("C5", 0.5), ("G4", 0.5), ("E4", 0.5), ("G4", 0.5), ("C5", 0.5), ("G4", 0.5)]),
            ('Life is but a dream.', [("C5", 1), ("G4", 1), ("E4", 1), ("C4", 1), ("C4", 2)]),
        ],
    },
    {
        "slug": 'london-bridge',
        ...
        "interest_tags": ["nursery", "classic"],
        "lines": [
            ('London Bridge is falling down,', [("G4", 1.5), ("A4", 0.5), ("G4", 1), ("F4", 1), ("E4", 1), ("F4", 1), ("G4", 2)]),
            ('Falling down, falling down,', [("D4", 1), ("E4", 1), ("F4", 1), ("F4", 1), ("E4", 1), ("F4", 1), ("G4", 2)]),
            ('London Bridge is falling down,', [("G4", 1.5), ("A4", 0.5), ("G4", 1), ("F4", 1), ("E4", 1), ("F4", 1), ("G4", 2)]),
            ('My fair lady.', [("D4", 1.5), ("E4", 0.5), ("F4", 1), ("E4", 1), ("C4", 1), ("C4", 2)]),
        ],
    },
    {
        "slug": 'old-macdonald',
        ...
        "bpm": BPM,
        "musical_key": "C",
        "interest_tags": ["nursery", "animals"],
        "lines": [
            ('Old MacDonald had a farm,', [("G4", 1), ("G4", 1), ("G4", 1), ("D4", 1), ("E4", 1), ("E4", 1), ("D4", 2)]),
            ('E-I-E-I-O.', [("B4", 1), ("B4", 1), ("A4", 1), ("A4", 1), ("G4", 2)]),
            ('And on his farm he had a cow,', [("G4", 1), ("G4", 1), ("G4", 1), ("D4", 1), ("E4", 1), ("E4", 1), ("D4", 2)]),
            ('E-I-E-I-O.', [("B4", 1), ("B4", 1), ("A4", 1), ("A4", 1), ("G4", 2)]),
        ],
    },
    {
        ...
        "interest_tags": ["nursery", "easy"],
        "lines": [
            ('Baa, baa, black sheep,', [("C4", 1), ("C4", 1), ("G4", 1), ("G4", 1), ("A4", 1), ("A4", 1), ("G4", 2)]),
            ('Have you any wool?', [("F4", 1), ("F4", 1), ("E4", 1), ("E4", 1), ("D4", 1), ("D4", 1), ("C4", 2)]),
            ('Yes sir, yes sir, three bags full.', [("G4", 1), ("G4", 1), ("F4", 1), ("F4", 1), ("E4", 1), ("E4", 1), ("D4", 2)]),
            ('One for my master and one for my dame.', [("C4", 1), ("C4", 1), ("G4", 1), ("G4", 1), ("A4", 1), ("A4", 1), ("G4", 2)]),
        ],
    },
    {
        "slug": 'jingle-bells',
        "title": 'Jingle Bells',
        "artist": 'Traditional · 合成旋律（公有领域民谣）',
        "album": "节日欢歌",
        "level": 2,
        "bpm": BPM,
        "musical_key": "C",
        "interest_tags": ["holiday", "classic"],
        "lines": [
            ('Jingle bells, jingle bells,', [("E4", 1), ("E4", 1), ("E4", 2), ("E4", 1), ("E4", 1), ("E4", 2)]),
            ('Jingle all the way.', [("E4", 1), ("G4", 1), ("C4", 1.5), ("D4", 0.5), ("E4", 4)]),
            ('Oh what fun it is to ride', [("F4", 1), ("F4", 1), ("F4", 1.5), ("F4", 0.5), ("F4", 1), ("E4", 1), ("E4", 1), ("E4", 0.5), ("E4", 0.5)]),
            ('In a one-horse open sleigh.', [("E4", 1), ("D4", 1), ("D4", 1), ("E4", 1), ("D4", 2), ("G4", 2)]),
        ],
    },
    {
        "slug": 'hot-cross-buns',
        ...
        "bpm": BPM,
        "musical_key": "C",
        "interest_tags": ["nursery", "short"],
        "lines": [
            ('Hot cross buns,', [("E4", 1), ("D4", 1), ("C4", 2)]),
            ('Hot cross buns,', [("E4", 1), ("D4", 1), ("C4", 2)]),
            ('One a penny, two a penny,', [("C4", 0.5), ("C4", 0.5), ("C4", 0.5), ("C4", 0.5), ("D4", 0.5), ("D4", 0.5), ("D4", 0.5), ("D4", 0.5)]),
            ('Hot cross buns.', [("E4", 1), ("D4", 1), ("C4", 2)]),
        ],
    },
    {
        ...
        "bpm": BPM,
        "musical_key": "C",
        "interest_tags": ["folk", "round"],
        "lines": [
            ('Frère Jacques, Frère Jacques,', [("C4", 1), ("D4", 1), ("E4", 1), ("C4", 1), ("C4", 1), ("D4", 1), ("E4", 1), ("C4", 1)]),
            ('Dormez-vous? Dormez-vous?', [("E4", 1), ("F4", 1), ("G4", 2), ("E4", 1), ("F4", 1), ("G4", 2)]),
            ('Sonnez les matines, sonnez les matines.', [("G4", 0.5), ("A4", 0.5), ("G4", 0.5), ("F4", 0.5), ("E4", 1), ("C4", 1), ("G4", 0.5), ("A4", 0.5), ("G4", 0.5), ("F4", 0.5), ("E4", 1), ("C4", 1)]),
            ('Ding dang dong, ding dang dong.', [("C4", 1), ("G3", 1), ("C4", 2), ("C4", 1), ("G3", 1), ("C4", 2)]),
        ],
    },
]
        ...
        songs_out.append(
            {
                "title": song["title"],
                "artist": song["artist"],
                # 专辑名（2026-09-22）：歌单行显示「歌手 · 专辑 + 时长」的展示字段
                "album": song["album"],
                "level": song["level"],
                ...
                # 封面（2026-09-22）：站点相对路径，资产在 data/seed/song-covers/<slug>.svg
                # （程序生成的矢量图，随仓库分发；后端公开路由 /api/v1/songs/covers/{name} 服务，
                #  与书封 reading/covers 同款）。文件名 = 本表 slug，单一真源，勿手改单个文件。
                "cover_url": f"/api/v1/songs/covers/{song['slug']}.svg",
